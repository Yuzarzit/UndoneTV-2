...
TRES_ACORDES       = cargar_categoria("series_tres_acordes.csv")
PROYECTO_PERCHI    = cargar_categoria("series_proyecto_perchi.csv")
ALEJO_Y_VALENTINA  = cargar_categoria("series_alejo_y_valentina.csv")
...
def generar_parrilla_semanal(inicio_semana_utc):
    ...
    series = [TRES_ACORDES, PROYECTO_PERCHI, ALEJO_Y_VALENTINA]
    idx_serie = 0
    def obtener_serie():
        nonlocal idx_serie
    ...
    <body>
        <div class="ie-window">
            ...
            <div class="page-content">
                ...
                <div class="creditos-box"><span>CREDITOS DE TRANSMISION:</span><br>- Series Web: Alejo y Valentina (Alejandro Szykula), Tres Acordes (Martin Garabal), Proyecto Perchi (Creadores Originales).<br>- Cortos: Mime and Dash (Derpixon).<br>- Musica: Radiohead, Weezer, My Chemical Romance, Green Day, Tally Hall, Red Hot Chili Peppers.<br>- Infraestructura: Undone TV Network.</div>
            </div>
